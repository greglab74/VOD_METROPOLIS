...
<body>
	...
	<div id="wrapper" style="margin-top:80px;">
		...
		<div class="carrousel">
			<div class="plan p1"><a href="fichefilm.php?idfilm=1"><img src="img/1.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p2"><a href="fichefilm.php?idfilm=2"><img src="img/2.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p3"><a href="fichefilm.php?idfilm=3"><img src="img/3.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p4"><a href="fichefilm.php?idfilm=4"><img src="img/4.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p5"><a href="fichefilm.php?idfilm=5"><img src="img/5.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p6"><a href="fichefilm.php?idfilm=52"><img src="img/6.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p7"><a href="fichefilm.php?idfilm=56"><img src="img/7.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
			<div class="plan p8"><a href="fichefilm.php?idfilm=59"><img src="img/8.jpeg" alt="Metropolis VOD" class="affiche" /></a></div>
		</div>
